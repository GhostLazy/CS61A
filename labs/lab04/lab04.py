def divide(quotients, divisors):
    ...
    """
    return {quotient: [divisor for divisor in divisors if not divisor % quotient] for quotient in quotients}
...
def closer_city(lat, lon, city_a, city_b):
    ...
    return get_name(city_a) if distance(loc, city_a) <= distance(loc, city_b) else get_name(city_b)
