...
def boar_brawl(player_score, opponent_score):
    ...
    return 3 * abs(tens - ones) if tens != ones else 1
    # END PROBLEM 2
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def stratety(score, opponent_score):
        return n
    return stratety
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    res, maxn = 1, 0
    for i in range(1, 11):
        average_score = make_averaged(roll_dice, times_called)(i, dice)
        if average_score > maxn:
            maxn = average_score
            res = i
    return res
    # END PROBLEM 9
